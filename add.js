...
if (rub1.classList.contains("active-left") && usd2.classList.contains("active-right")) {
    fetch("https://v6.exchangerate-api.com/v6/edefe5774608070adc63b330/latest/RUB")
    ...
    fetch("https://v6.exchangerate-api.com/v6/edefe5774608070adc63b330/latest/USD")
...
function valyuta(esasValyuta, hedefValyuta, container, text) {
    fetch(`https://v6.exchangerate-api.com/v6/edefe5774608070adc63b330/latest/${esasValyuta}`)
...
function valyutaSecimi1(baseLeft, baseRight) {
    fetch(`https://v6.exchangerate-api.com/v6/edefe5774608070adc63b330/latest/${baseLeft}`)
        .then(res => res.json())
        .then(data => {
